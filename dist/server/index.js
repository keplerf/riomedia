...
async function handleImageOptimization(request, handlers) {
...
}, "9bdebf4ad9f6", "default");
const Hero = /* @__PURE__ */ registerClientReference(() => {
  throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "643116334cb3", "default");
const services = [
  {
    number: "01",
    title: "Paid Media",
    description: "Google Ads, Meta, TikTok, and programmatic campaigns engineered for maximum ROAS. We don't guess — we optimize.",
    tags: ["Google Ads", "Meta Ads", "TikTok Ads", "Programmatic"]
  },
  {
    number: "02",
    title: "SEO & Content",
    description: "Long-term organic growth through technical SEO, content strategy, and authority building that compounds over time.",
    tags: ["Technical SEO", "Content Strategy", "Link Building"]
  },
  {
    number: "03",
    title: "Social Media",
    description: "Brand presence that converts. Creative content calendars, community management, and influencer partnerships.",
    tags: ["Content Creation", "Community", "Influencer"]
  },
  {
    number: "04",
    title: "Analytics & CRO",
    description: "Turn data into decisions. We audit, track, and optimize every touchpoint in your funnel to increase conversion rates.",
    tags: ["GA4", "Hotjar", "A/B Testing", "Funnel Audit"]
  }
];
function Services() {
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("section", { id: "services", className: "py-32 px-6 lg:px-12", children: /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-20", children: [
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("p", { className: "text-xs uppercase tracking-widest text-zinc-500 mb-4", children: "What we do" }),
        /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("h2", { className: "text-4xl sm:text-5xl font-bold leading-tight", children: [
          "Services built for",
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("span", { className: "text-accent", children: "measurable growth." })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-px bg-[#1f1f1f]", children: services.map((s) => /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("span", { className: "text-xs font-mono text-zinc-600", children: s.number }),
            /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("span", { className: "w-8 h-8 rounded-full border border-[#2a2a2a] flex items-center justify-center text-zinc-600 group-hover:border-accent group-hover:text-accent transition-colors text-lg leading-none", children: "↗" })
          ] }),
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("h3", { className: "text-2xl font-bold", children: s.title }),
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("p", { className: "text-zinc-400 leading-relaxed text-sm", children: s.description }),
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("div", { className: "flex flex-wrap gap-2 mt-auto pt-4", children: s.tags.map((tag) => /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(
            "span",
            {
...
function Work() {
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("section", { id: "work", className: "py-32 px-6 lg:px-12 bg-[#080808]", children: /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "mb-20", children: [
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("p", { className: "text-xs uppercase tracking-widest text-zinc-500 mb-4", children: "Selected work" }),
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("h2", { className: "text-4xl sm:text-5xl font-bold", children: [
        "Results that",
        /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("span", { className: "text-accent", children: "speak for themselves." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("div", { className: "flex flex-col divide-y divide-[#1f1f1f]", children: projects.map((p, i) => /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("span", { className: "relative text-xs font-mono text-zinc-600 sm:w-16", children: String(i + 1).padStart(2, "0") }),
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "relative flex-1", children: [
            /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("h3", { className: "text-2xl font-bold group-hover:text-accent transition-colors", children: p.client }),
            /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("p", { className: "text-sm text-zinc-500 mt-1", children: p.category })
          ] }),
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "relative sm:text-right", children: [
            /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("p", { className: "text-sm font-medium text-zinc-300", children: p.result }),
            /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("p", { className: "text-xs text-zinc-600 mt-1", children: p.year })
          ] }),
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("span", { className: "relative hidden sm:block ml-10 text-zinc-700 group-hover:text-accent group-hover:translate-x-1 transition-all", children: "→" })
        ]
      },
      p.client
    )) })
...
const Contact = /* @__PURE__ */ registerClientReference(() => {
  throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "2b3f3bb34ba2", "default");
function Footer() {
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("footer", { className: "border-t border-[#1f1f1f] px-6 lg:px-12 py-10", children: /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-zinc-600", children: [
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("span", { children: [
      "rio",
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("span", { className: "text-accent", children: "media" })
    ] }),
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("span", { children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Rio Media. All rights reserved."
    ] }),
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("a", { href: "#", className: "hover:text-zinc-400 transition-colors", children: "Instagram" }),
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("a", { href: "#", className: "hover:text-zinc-400 transition-colors", children: "LinkedIn" }),
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("a", { href: "#", className: "hover:text-zinc-400 transition-colors", children: "X" })
    ] })
  ] }) });
}
function Home() {
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs(jsxRuntime_reactServerExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(Services, {}),
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(Work, {}),
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(Contact, {})
    ] }),
...
let metadata = {
  title: "Rio Media — Digital Marketing Agency",
  description: "Rio Media is a digital marketing agency that drives growth through bold strategy, creative content, and performance-focused campaigns."
};
function RootLayout({
  children
}) {
